...
;; ②プロキシー設定(必要があれば)  - (setq url-proxy-services '(("http" . "192.168.1.200:8080")))
;; ③magit の git path 設定        - (setq magit-git-executable "C:/ProgramData/chocolatey/lib/git.commandline/tools/bin/git.exe")) # PATH を通したため不要
...
;;   ※以下の操作が面倒なら、portablgit/home の .gitconfig ファイルの内容を C:/ProgramData/chocolatey/lib/git.commandline/tools/etc/gitconfig に反映してもいいかも
...
;;
;; markdown(realtime-preview) を使う場合
...
;; PATH に含まれたため不要
;; (setq git-gutter+-git-executable "C:/ProgramData/chocolatey/lib/git.commandline/tools/bin/git.exe")
